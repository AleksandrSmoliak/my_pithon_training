...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.login(wd)
        self.create_new_contact(wd, firstname="Александр", middlename="Владимирович", lastname="Смоляк", nickname="Crucis",
    ...
    def create_new_contact(self, wd, firstname, middlename, lastname, nickname, title, company, address, home_phone,
        ...
        if not wd.find_element_by_xpath(option_day_birthday).is_selected():
            wd.find_element_by_xpath(option_day_birthday).click()
        # Выбор месяца даты рождения (выпадающий список)
        if not wd.find_element_by_xpath(option_month_birthday).is_selected():
            wd.find_element_by_xpath(option_month_birthday).click()
        # Заполнение поля "Год рождения"
        wd.find_element_by_name("byear").click()
        wd.find_element_by_name("byear").clear()
        wd.find_element_by_name("byear").send_keys(year_birthday)
